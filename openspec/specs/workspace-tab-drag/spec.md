...
Defines drag-initiation behavior for tab labels in workspace tab strips:
arming, activation (movement threshold or Ctrl), preserved click-to-switch
behavior, and "picked up" visual feedback, integrated with the existing
workspace tool drag-and-drop pipeline.
