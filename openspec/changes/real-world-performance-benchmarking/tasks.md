...
- [ ] 1.1 Define versioned types for run configuration, hardware/runtime provenance, raw trial measurements, summaries, warnings, and completion status
- [ ] 1.2 Define scenario and optimization-strategy interfaces with stable identifiers, parameter schemas, compatibility checks, and correctness assertions
- [ ] 1.3 Implement deterministic fake scenarios, strategies, clocks, and telemetry collectors for runner tests
