...
"""Run a manual GUI verification session.
    ...
    python3 tools/scripts/manual_gui --quick
    python3 tools/scripts/manual_gui --full --geometry-sweep
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(
            ...
            f"\n"
            f"    uv run tools/scripts/manual_gui --quick\n",
            file=sys.stderr,
        )
        ...
        if not in_venv and (REPOSITORY_ROOT / ".venv").is_dir():
            print(
                ...
                f"\n"
                f"    {REPOSITORY_ROOT / '.venv' / 'bin' / 'python3'} tools/scripts/manual_gui --quick\n",
                file=sys.stderr,
            )
