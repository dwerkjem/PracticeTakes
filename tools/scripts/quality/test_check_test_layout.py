#!/usr/bin/env python3
"""Tests for the src/tests/-mirrors-src/ layout check."""
...
class CheckTestLayoutTests(unittest.TestCase):
    ...
    def test_a_conforming_tree_has_no_problems(self) -> None:
        self.make_source_directory("src/services/score")
        self.write_test("src/services/score/TempoMapTests.cpp")
    ...
    def test_a_mirrored_path_with_no_source_is_rejected(self) -> None:
        ...
        self.write_test("src/services/ghost/GhostTests.cpp")
    ...
    def test_a_directory_named_like_an_exempt_one_deeper_down_is_not_exempt(self) -> None:
        ...
        self.write_test("src/services/support/Thing.cpp")
    ...
    def test_the_real_repository_tree_conforms(self) -> None:
        ...
        self.assertEqual(
            find_problems(repository_root / "src" / "tests", repository_root / "src"), []
        )
