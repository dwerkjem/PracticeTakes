...
- [Building](../docs/development/build/BUILDING.md) — prerequisites, local
  configuration, and run commands
- [Architecture](../docs/development/architecture/ARCHITECTURE.md) — application ownership,
...
- [Design and architecture review checklist](../docs/development/architecture/ARCHITECTURE_QA.md) —
  what reviewers check on pull requests beyond formatting/linting
- [QA strategy](../docs/development/quality/QA_STRATEGY.md) — the current CI/testing
  gap analysis and plan
- [Code style](../docs/development/quality/CODE_STYLE.md) — readability and real-time
  audio guidelines
- [Code quality](../docs/development/quality/QUALITY.md) — clang-format, clang-tidy,
...
- `docs/` — developer documentation, grouped by subject under
  `docs/development/` (`build/`, `architecture/`, `quality/`, `performance/`,
  `operations/`, `agents/`), plus `docs/contracts/` for the shared
  wire-format schemas. New documents go in the matching subdirectory and get
  a line in `docs/development/README.md`
...
- `README.md`, `CMakeLists.txt`, `LICENSE`, `CLAUDE.md` — files whose tooling
  ...
  [`docs/development/agents/AGENT_GUIDE.md`](../docs/development/agents/AGENT_GUIDE.md)
...
checklist pass](../docs/development/architecture/ARCHITECTURE_QA.md) for the criteria.
